...
def Draw(k,TestAccuracy,TrainAccuracy):      
    plt.figure(figsize=(12, 8))
    plt.xticks(np.arange(0, k+1, 1.0))
    l1, = plt.plot(range(1,21),TestAccuracy, label='Testing Error')
    l2, = plt.plot(range(1,21),TrainAccuracy, linewidth=1.0, linestyle='--', label='Training Error')
